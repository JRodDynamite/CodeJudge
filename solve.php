...
<script src="js/python.js"></script>
    ...
    <script language="javascript">
      ...
      function changeLang(lang) {
        ...
        $('.CodeMirror.cm-s-default').remove();
        if(lang == 'C'){
          $('#hlang').val('c');
          $('textarea').attr("id","c-code");
          c_code();
        }
        else if(lang== 'C++'){
          $('#hlang').val('cpp');
          $('textarea').attr("id","cpp-code");
          cpp_code();
        }
        else if(lang== 'Java'){
          $('#hlang').val('java');
          $('textarea').attr("id","java-code");
          java_code();
        }
        else if(lang== 'Python'){
          $('#hlang').val('python');
      ...
      var cEditor = CodeMirror.fromTextArea(document.getElementById("text"), {
            lineNumbers: true,
            matchBrackets: true,
            mode: "text/x-csrc"
          });
